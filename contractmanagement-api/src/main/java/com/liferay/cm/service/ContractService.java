...
/**
 * Provides the remote service interface for Contract. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see ContractServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
@OSGiBeanProperties(
	property = {
		"json.web.service.context.name=cm",
		"json.web.service.context.path=Contract"
	},
	service = ContractService.class
)
@ProviderType
@Transactional(
...
public interface ContractService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ContractServiceUtil} to access the contract remote service. Add custom service methods to <code>com.liferay.cm.service.impl.ContractServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
