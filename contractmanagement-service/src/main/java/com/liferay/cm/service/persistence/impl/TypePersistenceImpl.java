...
import com.liferay.cm.model.impl.TypeImpl;
import com.liferay.cm.model.impl.TypeModelImpl;
...
public class TypePersistenceImpl
	 ...
	 */
	@Override
	public List<Type> findByGroupId(
	...
	public Type[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, type, groupId, orderByComparator, true);

			array[1] = type;

			array[2] = getByGroupId_PrevAndNext(
				session, type, groupId, orderByComparator, false);
	...
	protected Type getByGroupId_PrevAndNext(
		Session session, Type type, long groupId,
		OrderByComparator<Type> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Type> filterFindByGroupId(
		long groupId, int start, int end,
		OrderByComparator<Type> orderByComparator) {
		...
		String sql = InlineSQLHelperUtil.replacePermissionCheck(
			query.toString(), Type.class.getName(),
	...
	protected Type filterGetByGroupId_PrevAndNext(
		Session session, Type type, long groupId,
		OrderByComparator<Type> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Type> findByG_C(long groupId, long typeId) {
		return findByG_C(
			groupId, typeId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Type> findByG_C(long groupId, long typeId, int start, int end) {
		return findByG_C(groupId, typeId, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Type> findByG_C(
		long groupId, long typeId, int start, int end,
		OrderByComparator<Type> orderByComparator) {

		return findByG_C(groupId, typeId, start, end, orderByComparator, true);
	}
	...
	public List<Type> findByG_C(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] {
				groupId, typeId, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_C_TYPEID_2);
	...
	public Type findByG_C_First(
		...
		Type type = fetchByG_C_First(groupId, typeId, orderByComparator);
	...
	public Type fetchByG_C_First(
		long groupId, long typeId, OrderByComparator<Type> orderByComparator) {

		List<Type> list = findByG_C(groupId, typeId, 0, 1, orderByComparator);
	...
	public Type findByG_C_Last(
		...
		Type type = fetchByG_C_Last(groupId, typeId, orderByComparator);
	...
	public Type fetchByG_C_Last(
		...
		int count = countByG_C(groupId, typeId);

		if (count == 0) {
			return null;
		}

		List<Type> list = findByG_C(
			groupId, typeId, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public List<Type> filterFindByG_C(long groupId, long typeId) {
	 ...
	 */
	@Override
	public List<Type> filterFindByG_C(
		long groupId, long typeId, int start, int end) {

		return filterFindByG_C(groupId, typeId, start, end, null);
	}
	...
	public List<Type> filterFindByG_C(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_C(groupId, typeId, start, end, orderByComparator);
		}
	...
	public void removeByG_C(long groupId, long typeId) {
		for (Type type :
				findByG_C(
					groupId, typeId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	public int filterCountByG_C(long groupId, long typeId) {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_C(groupId, typeId);
		}
	...
	private static final String _FINDER_COLUMN_G_C_TYPEID_2 = "type.typeId = ?";
	...
	public TypePersistenceImpl() {
		...
		setEntityCacheEnabled(TypeModelImpl.ENTITY_CACHE_ENABLED);
	...
	public Type updateImpl(Type type) {
		...
		if (!TypeModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			args = new Object[] {
				typeModelImpl.getGroupId(), typeModelImpl.getTypeId()
			};
			...
			if ((typeModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					typeModelImpl.getOriginalGroupId(),
					typeModelImpl.getOriginalTypeId()
				};
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			TypeModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByG_C = new FinderPath(
			...
			TypeModelImpl.GROUPID_COLUMN_BITMASK |
			TypeModelImpl.TYPEID_COLUMN_BITMASK |
			TypeModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
	...
	private static final String _FILTER_SQL_SELECT_TYPE_WHERE =
		"SELECT DISTINCT {type.*} FROM CM_Type type WHERE ";

	private static final String
		_FILTER_SQL_SELECT_TYPE_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {CM_Type.*} FROM (SELECT DISTINCT type.typeId FROM CM_Type type WHERE ";

	private static final String
		_FILTER_SQL_SELECT_TYPE_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN CM_Type ON TEMP_TABLE.typeId = CM_Type.typeId";

	private static final String _FILTER_SQL_COUNT_TYPE_WHERE =
		"SELECT COUNT(DISTINCT type.typeId) AS COUNT_VALUE FROM CM_Type type WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "type";

	private static final String _FILTER_ENTITY_TABLE = "CM_Type";

	private static final String _ORDER_BY_ENTITY_ALIAS = "type.";

	private static final String _ORDER_BY_ENTITY_TABLE = "CM_Type.";
