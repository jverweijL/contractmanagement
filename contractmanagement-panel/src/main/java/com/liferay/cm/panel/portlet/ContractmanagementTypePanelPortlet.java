...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=ContractmanagmentTypePanel",
...
public class ContractmanagementTypePanelPortlet extends MVCPortlet {
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse) throws IOException, PortletException {
		...
		renderRequest.setAttribute("typeCount", _TypeService.getTypesCount());
		renderRequest.setAttribute("types",_TypeService.getTypes(0,10));
